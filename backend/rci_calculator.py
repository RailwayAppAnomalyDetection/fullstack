...
def get_map_data():
    """
    Retrieve processed map data for visualisation
    - Reads the processed CSV file generated by ` /calculate-rci `
    - Extracts latitude, longitude, and Ride_Comfort_Index columns
    - Filters ut rows with invalid coordinates or high PDOP values (>1000)
    Returns: JSON array of map data points"""
    try:
