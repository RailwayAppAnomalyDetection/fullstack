...
const Layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="flex h-screen overflow-hidden">
      {/* サイドバー */}
      <aside className="bg-blue-900 text-white w-1/5 p-4 flex flex-col">
        ...
        <nav className="flex flex-col gap-4">
          ...
          <details className="group">
            <summary className="cursor-pointer hover:bg-blue-700 p-2 rounded">
              Measurement
            </summary>
            <div className="pl-4 space-y-2 flex flex-col">
              <button className="text-left hover:bg-blue-700 p-2 rounded">
                Assessment
              </button>
              <button className="text-left hover:bg-blue-700 p-2 rounded">
                Regular Train
